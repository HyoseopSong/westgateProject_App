...
{
    public partial class secondThird_west : ContentPage
	{
		public bool onProcessing;
        public secondThird_west()
        {
			InitializeComponent();
			absL.AnchorX = 0;
			absL.AnchorY = 0;
			...
			AbsoluteLayout.SetLayoutBounds(boundaryBox, new Rectangle(550 * absL.Scale, App.ScreenWidth, 0, 30));
		...
		async void OnTapped(object sender, EventArgs args)
		{
			if (!onProcessing)
			{
				...
				await Navigation.PushAsync(new ShopInfoPage("SecondBuilding", "3층", temp.Text));
				onProcessing = false;
			}
		}
