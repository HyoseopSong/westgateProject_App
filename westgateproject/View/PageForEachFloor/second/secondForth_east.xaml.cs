...
{
    public partial class secondForth_east : ContentPage
	{
        ...
        public secondForth_east()
        {
			...
			{
				case Device.Android:
					absL.Scale = (App.ScreenHeight - 90) / 249;
					break;
				default:
					absL.Scale = (App.ScreenHeight - 70) / 249;
					break;
			}
			...
			AbsoluteLayout.SetLayoutBounds(boundaryBox, new Rectangle(500 * absL.Scale, App.ScreenWidth, 0, 30));
		...
		async void OnTapped(object sender, EventArgs args)
		{
			if (!onProcessing)
			{
				...
				await Navigation.PushAsync(new ShopInfoPage("SecondBuilding", "4층", temp.Text));
				onProcessing = false;
			}
		}
